...
csvData = readmatrix('smallest/25-2-3.csv');
plot(csvData, "-o")
...
[peaks, locations] = findpeaks(dataAvgDiff, 'MinPeakHeight', 1.15, 'MinPeakDistance', 2);
...
fprintf('Barcode: %d\nLength: %d\nLetter: %s\n', barcode, length(filteredWidths), letter);
